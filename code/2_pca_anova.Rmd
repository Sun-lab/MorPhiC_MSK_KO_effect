...
out_dir = "/home/zli4/MSK_DEC24/Analysis/outs/anova"
...
```{r pca-features,fig.width = 8, fig.height = 10, warning=FALSE,message=FALSE}
...
for(tp in c("D-1","D3","D7","D11","D18")){
  ...
  ggsave(file.path(out_dir,paste0("pc_plots/",tp,".png",sep='')),fig,width = 8,height = 10)
}
